...
import net.ccbluex.liquidbounce.AloxClient.background
import net.ccbluex.liquidbounce.AloxClient.isStarting
...
object FileManager : MinecraftInstance, Iterable<FileConfig> by FILE_CONFIGS {
    ...
    val dir = File(mc.mcDataDir, "ALOXCLIENT")
    ...
    fun load(name: String, save: Boolean = true) {
        AloxClient.isLoadingConfig = true
        ...
        AloxClient.isLoadingConfig = false
    }
}
