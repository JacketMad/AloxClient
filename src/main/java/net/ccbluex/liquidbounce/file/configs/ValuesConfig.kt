...
class ValuesConfig(file: File) : FileConfig(file) {
    ...
    override fun loadConfig() {
        ...
        // Compare versions
        if (prevVersion != AloxClient.clientVersionText) {
            // Backup old version config before loading the new one
            FileManager.backupAllConfigs(prevVersion, AloxClient.clientVersionText)
        }
    ...
    override fun saveConfig() {
        val jsonObject = JsonObject().apply {
            ...
            addProperty("ClientVersion", AloxClient.clientVersionText)
        }
