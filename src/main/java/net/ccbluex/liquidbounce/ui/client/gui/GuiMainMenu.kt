...
import net.ccbluex.liquidbounce.AloxClient.CLIENT_NAME
import net.ccbluex.liquidbounce.AloxClient.clientVersionText
...
class GuiMainMenu : AbstractScreen(), GuiYesNoCallback {
    ...
    override fun drawScreen(mouseX: Int, mouseY: Int, partialTicks: Float) {
        ...
        val branch = AloxClient.clientBranch
    ...
    private fun showWelcomePopup() {
        popup = PopupScreen {
            ...
            message(
                ...
                - §fGithub: §9https://github.com/SkidderMC/AloxClient
    ...
    private fun fetchLatestGithubRelease(): GithubRelease? = try {
        HttpClient.get("https://api.github.com/repos/SkidderMC/AloxClient/releases/latest")
    ...
    private fun checkOutdatedVersionPopup() {
        if (!isLatest && canConnect) {
            popup = PopupScreen {
                ...
                button("§aDownload Update") { MiscUtils.showURL("https://github.com/SkidderMC/AloxClient/releases/latest") }
                onClose { popup = null }
            }
        }
    }
