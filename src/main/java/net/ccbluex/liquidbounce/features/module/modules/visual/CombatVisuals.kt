...
object CombatVisuals : Module("CombatVisuals", Category.VISUAL, subjective = true) {
    ...
    // Mark - TargetESP
    private val markValue by choices("MarkMode", arrayOf("None", "Zavz", "Circle", "AloxMark", "Lies", "FDP", "Sims", "Box", "RoundBox", "Head", "Mark"), "Zavz")
    private val isMarkMode: Boolean
        get() = markValue != "None" && markValue != "Sims" && markValue != "FDP"  && markValue != "Lies" && markValue != "AloxMark"
    ...
    private val alphaValue by int("Alpha", 255, 0.. 255) { isMarkMode && markValue == "Zavz" && markValue == "AloxMark"}
