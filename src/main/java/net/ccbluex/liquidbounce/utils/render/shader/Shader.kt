...
abstract class Shader : MinecraftInstance {
    ...
    constructor(fragmentShader: String) {
        ...
        try {
            val vertexStream = javaClass.getResourceAsStream("/assets/minecraft/aloxclient/shader/vertex.vert")
            vertexShaderID = createShader(IOUtils.toString(vertexStream), ARBVertexShader.GL_VERTEX_SHADER_ARB)
            IOUtils.closeQuietly(vertexStream)
            
            val fragmentStream = javaClass.getResourceAsStream("/assets/minecraft/aloxclient/shader/fragment/$fragmentShader")
